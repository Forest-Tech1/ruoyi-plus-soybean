      ...
      <div class="flex items-center justify-center">
        <NCheckbox
          ...
          onUpdateChecked={(v: boolean) => {
            row.hold = v;
            if (v) row.deliveryMethod = 'hold';
            else if (row.deliveryMethod === 'hold') row.deliveryMethod = null;
          }}
        />
      </div>
    )
