...
• Job No → systemSoNo; multiple SOs in one cell (line breaks etc.) → normalize to one comma-separated string
• CTNS → totalPieces
...
• Hold column: if cell contains substring HOLD (case-insensitive) → deliveryMethod "暂扣"; else → "卡车派送"
...
Other master fields may be empty or defaulted by backend if missing; template should match these headers.`,
        ...
        inboundPlanRowNeedIdentifier: 'Row {index}: enter either System SO No. or Shipment code',
      ...
      inventory: {
        ...
        location: {
          ...
          filterPlaceholder: 'Filter by zone or location',
